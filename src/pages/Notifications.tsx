...
import NotificationManagementScreen from '@/components/NotificationManagement';
  ...
  return (
    <AdminSidebar>
      <div className="min-h-screen bg-gray-50">
        ...
        >
          <h1 className="text-3xl font-bold text-kid-blue mb-6">Gerenciamento de Notificações</h1>
